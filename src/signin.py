...
prompt_login_url = "https://chat.openai.com/api/auth/signin/auth0?prompt=login"
ContentType = "application/x-www-form-urlencoded"
UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36"
auth_url = "https://auth0.openai.com"

check_identifier_url = f"{auth_url}/u/login/identifier?state="
check_password_url = f"{auth_url}/u/login/password?state="
...
class Sigin:
    ...
    def _check_password(self, state, identifier, password):
        form_param = {
            "username": identifier,
            "password": password,
            "state": state,
    ...
    def sigin(self):
        identifier = "logical_camel@aiok.me"
        password = "Rteshe476E9yuTy"
        csrf = self._get_csrf()
        ...
        self._check_identifier(state, identifier)
        self._check_password(state, identifier, password)
